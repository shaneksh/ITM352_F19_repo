...
function addAlohaBowlToCart() {
    ...
    alert("Aloha Bowl added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addManaBowlToCart() {
    ...
    alert("Mana Bowl added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addWomensShirtToCart() {
    ...
    alert("Makai Women's T-Shirt added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addMensShirtToCart() {
    ...
    alert("Makai Men's T-Shirt added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addWomensSleeveToCart() {
    ...
    alert("Makai Women's Longsleeve added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addMensSleeveToCart() {
    ...
    alert("Makai Men's Longsleeve added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addWomensJacketToCart() {
    ...
    alert("Makai Women's Jacket added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addMensJacketToChart() {
    ...
    alert("Makai Men's Jacket added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addHatToCart() {
    ...
    alert("Makai Hat added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addBagToCart() {
    ...
    alert("Makai Reusable Bag added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addChainToCart() {
    ...
    alert("Makai Key Chain added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}
...
function addBottleToCart() {
    ...
    alert("Makai Reusable Water Bottle added to cart. Make sure to enter quantities in cart"); //alert the user the item was added to the cart
}